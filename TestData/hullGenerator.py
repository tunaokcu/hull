...
def testForNpointsWithoutDupes(algorithm, n=10, log=False):
    #Reliably find correct relative path
    dirname = os.path.dirname(__file__)
    parentDir = os.path.abspath(os.path.join(dirname, '..'))
    filename = os.path.join(parentDir, "Algorithms\TestRandomWithoutDuplicates.js")

    #Prepare the command
    commandToRun = ["node", filename, algorithm, str(n)]

    #Run the command and capture output
    output = subprocess.run(commandToRun, capture_output=True, text=True)

    #Catch output
    unprocessedOutput =  output.stdout.strip().split("\n")
    [input, output] = [unprocessedOutput[0], unprocessedOutput[-1]]
...
def randomTestWithoutDupes(algorithm, pointCount, testCount, log=False):
    for _ in range(testCount):
        if testForNpointsWithoutDupes(algorithm, pointCount, log) == False:
            return
...
#grahamBugMinimized = [[0.57, 1.11], [0.6, 0.94], [0.69, 0.79], [0.82, 0.68], [0.98, 0.62], [1.16, 0.62], [1.32, 0.68], [1.45, 0.79], [1.54, 0.94], [1.57, 1.11], [2.28, 0.64], [2.25, 0.81], [2.17, 0.96], [2.03, 1.07], [1.87, 1.13], [1.7, 1.13], [1.53, 1.07], [1.4, 0.96], [1.31, 0.81], [1.28, 0.64], [1.31, 0.47], [1.4, 0.32], [1.53, 0.21], [1.7, 0.15], [1.87, 0.15], [2.03, 0.21], [2.17, 0.32], [2.25, 0.47], [2.28, 0.64], [0.57, 1.89], [0.54, 2.06], [0.45, 2.21], [0.32, 2.32], [0.16, 2.38], [-0.02, 2.38], [-0.18, 2.32], [-0.31, 2.21], [-0.4, 2.06], [-0.43, 1.89], [-0.4, 1.71], [-0.31, 1.56], [-0.18, 1.45], [-0.02, 1.39], [0.16, 1.39], [0.32, 1.45], [0.45, 1.56], [0.54, 1.71], [0.57, 1.89], 
#[1.37, -1.57], [1.34, -1.39], [1.25, -1.24], [1.12, -1.13], [0.96, -1.07], [0.78, -1.07], [0.62, -1.13], [0.49, -1.24], [0.4, -1.39], [0.37, -1.57], [0.4, -1.74], [0.49, -1.89], [0.62, -2.0], [0.78, -2.06], [0.96, -2.06], [1.12, -2.0], [1.25, -1.89], [1.34, -1.74], [1.37, -1.57], [-1.2, -1.85], [-1.23, -1.68], [-1.32, -1.53], [-1.45, -1.42], [-1.62, -1.36], [-1.79, -1.36], [-1.95, -1.42], [-2.09, -1.53], [-2.17, -1.68], [-2.2, -1.85], [-2.17, -2.02], [-2.09, -2.17], [-1.95, -2.28], [-1.79, -2.34], [-1.62, -2.34], [-1.45, -2.28], [-1.32, -2.17], [-1.23, -2.02], [-1.2, -1.85], [-1.81, 0.24], [-1.84, 0.41], [-1.93, 0.56], [-2.06, 0.67], [-2.22, 0.73], [-2.4, 0.73], [-2.56, 0.67], [-2.69, 0.56], [-2.78, 0.41], [-2.81, 0.24], [-2.78, 0.07], [-2.69, -0.08], [-2.56, -0.19], [-2.4, -0.25], [-2.22, -0.25], [-2.06, -0.19], [-1.93, -0.08], [-1.84, 0.07], [-1.81, 0.24], [1.96, 2.22], [1.93, 2.39], [1.85, 2.54], [1.71, 2.65], [1.55, 2.71], [1.38, 2.71], [1.21, 2.65], [1.08, 2.54], [0.99, 2.39], [0.96, 2.22], [0.99, 2.05], [1.08, 1.9], [1.21, 1.78], [1.38, 1.72], [1.55, 1.72], [1.71, 1.78], [1.85, 1.9], [1.93, 2.05], [1.96, 2.22]]#[[-2.69, 0.56], [-2.78, 0.41], [-2.81, 0.24], [-2.78, 0.07], [-2.69, -0.08], [-2.56, -0.19], [-2.4, -0.25], [-2.22, -0.25], [-2.06, -0.19], [-1.93, -0.08], [-1.84, 0.07], [-1.81, 0.24], [1.96, 2.22], [1.93, 2.39], [1.85, 2.54], [1.71, 2.65], [1.55, 2.71], [1.38, 2.71], [1.21, 2.65], [1.08, 2.54], [0.99, 2.39], [0.96, 2.22], [0.99, 2.05], [1.08, 1.9], [1.21, 1.78], [1.38, 1.72], [1.55, 1.72], [1.71, 1.78], [1.85, 1.9], [1.93, 2.05], [1.96, 2.22]]#hullDebugger(grahamBug, lambda x: arrayTestWithoutDupes(x, "graham"))

arrayTestWithoutDupes(grahamBug, "graham")
"""
randomTestWithoutDupes("graham", 100, 10)